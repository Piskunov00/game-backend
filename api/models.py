...
from api.utils.bicycles import choicer
...
class Gamer(AbstractUser):
    ...
    name = models.CharField(null=False, max_length=120, blank=False, unique=True)
    ...
    def __str__(self):
        return '{}. GAMER-{}'.format(self.id, self.name)
...
class Game(models.Model):
    ...
    def __str__(self):
        return '{}. GAME-{}'.format(self.id, self.link)
